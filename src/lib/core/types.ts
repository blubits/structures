...
/**
 * Represents a single line of pseudocode for an operation.
 */
...
/**
 * Operation interface with pseudocode and highlight mapping capabilities.
 */
export interface OperationWithPseudocode extends Operation {
  /** Pseudocode lines for this operation */
