...
import { generateBSTInsertStates, generateBSTSearchStates, generateBSTFindMinStates, generateBSTFindMaxStates } from "@/structures/BinaryTree/variants/BST/algorithms";
